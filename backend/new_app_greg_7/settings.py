"""
Django settings for new_app_greg_7 project.
...
ROOT_URLCONF = 'new_app_greg_7.urls'
...
WSGI_APPLICATION = 'new_app_greg_7.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "new app Greg Support <support@new-app-greg-7.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_app_greg_7 API",
    "DESCRIPTION": "API documentation for new_app_greg_7 App",
    "VERSION": "v1",
}
